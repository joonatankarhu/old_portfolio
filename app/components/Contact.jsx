...
const Contact = () => {
  return (
    <div className="flex flex-col lg:w-full lg:items-end lg:border-t-2 lg:mt-20 lg:pt-5 items-center justify-center gap-2 mt-10 text-lg my-5 lg:text-gray-700/70">
